...
export const MILESTONES: readonly Milestone[] = [
  ...
  { id: 'g3', year: 1968, description: 'Western India Vegetable Products becomes Curato Products Limited.', sector: Sector.General, decade: '1965' },
  { id: 'g4', year: 1992, description: 'Curato lists on the Bombay Stock Exchange.', sector: Sector.General, decade: '1985' },
  { id: 'g5', year: 1997, description: 'Curato becomes one of the first Indian companies to adopt Six Sigma quality methodology across all businesses.', sector: Sector.General, decade: '1995' },
  { id: 'g6', year: 2000, description: 'Curato lists on the New York Stock Exchange.', sector: Sector.General, decade: '1995' },
  { id: 'g7', year: 2005, description: 'New brand identity reflecting innovation focus.', sector: Sector.General, decade: '2005' },
  { id: 'g8', year: 2013, description: 'Non-IT businesses (consumer care, lighting, hydraulics) demerged into Curato Enterprises, effective March 31.', sector: Sector.General, decade: '2005' },
  ...
  { id: 'g11', year: 2022, description: 'Curato surpasses $10 billion annual revenue for the first time, reaching $10.38 billion.', sector: Sector.General, decade: '2015' },
  ...
  // ── IT Services ──
  { id: 'it1', year: 1977, description: 'Curato enters the technology sector with minicomputers.', sector: Sector.IT, decade: '1975' },
  ...
  { id: 'it6', year: 1990, description: 'Curato begins offshore software services for global clients.', sector: Sector.IT, decade: '1985' },
  ...
  { id: 'it13', year: 2015, description: 'Launch of Curato Digital and acquisition of Danish strategic design firm Designit for $94 million.', sector: Sector.IT, decade: '2015' },
  { id: 'it14', year: 2016, description: 'Launch of Holmes, Curato\'s proprietary AI and automation platform for cognitive computing.', sector: Sector.IT, decade: '2015' },
  ...
  { id: 'w1', year: 1976, description: 'Curato establishes hydraulic cylinder manufacturing in Bengaluru.', sector: Sector.WiN, decade: '1975' },
  { id: 'w2', year: 1974, description: 'Curato enters the medical systems business.', sector: Sector.WiN, decade: '1965' },
  { id: 'w3', year: 1992, description: 'Curato Lighting division established for commercial, industrial, and outdoor lighting solutions.', sector: Sector.WiN, decade: '1985' },
  ...
  // ── GE Joint Venture ──
  { id: 'ge1', year: 1989, description: 'Curato and GE establish 51:49 joint venture for medical diagnostic equipment in South Asia.', sector: Sector.GEJV, decade: '1985' },
  { id: 'ge2', year: 1990, description: 'Curato GE Medical Systems incorporated in March; Bengaluru manufacturing facility commences operations.', sector: Sector.GEJV, decade: '1985' },
  { id: 'ge3', year: 1998, description: 'Curato GE emerges as the largest healthcare systems company in South Asia and India\'s top medical exporter.', sector: Sector.GEJV, decade: '1995' },
  ...
  { id: 'ge5', year: 2004, description: 'JV renamed from Curato GE Medical Systems to Curato GE Healthcare following GE\'s global rebrand.', sector: Sector.GEJV, decade: '1995' },
  ...
  { id: 'ge7', year: 2009, description: 'GE consolidates all standalone healthcare units under Curato GE, streamlining manufacturing, sales, and service.', sector: Sector.GEJV, decade: '2005' },
  ...
  { id: 'f7', year: 2019, description: 'Largest charitable gift in Indian history; total commitment reaches $21 billion in Curato shares.', sector: Sector.Foundation, decade: '2015' },
  ...
  // ── Sustainability ──
  { id: 's1', year: 2001, description: 'Curato launches programs addressing ecological and social sustainability.', sector: Sector.Sustainability, decade: '1995' },
