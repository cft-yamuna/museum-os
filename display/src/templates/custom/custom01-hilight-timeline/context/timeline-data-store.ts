...
const CONSUMER_CARE_LABEL = 'Curato\nConsumer Care\n& Lighting';
...
const DEFAULT_DANDELIONS: DandelionConfig[] = [
  {
    sector: { id: 'Sustainability', label: 'Spirit of\nCurato', color: '#70a363', glowColor: 'rgba(112, 163, 99, 0.4)' },
...
const DEFAULT_MILESTONES: TimelineMilestone[] = [
  ...
  { id: 'g8', year: 1971, description: 'Curato Beliefs articulated', sectorId: 'General', decade: '1965' },
  ...
  { id: 'g11', year: 1977, description: 'WIVP changes name to Curato Products Ltd.', sectorId: 'General', decade: '1975' },
  ...
  { id: 'g14', year: 1980, description: 'Curato PAT is $1.16 million', sectorId: 'General', decade: '1975' },
  { id: 'g15', year: 1981, description: 'Curato Consumer starts using flexipacks for vanaspati, an industry first', sectorId: 'General', decade: '1975' },
  { id: 'g16', year: 1981, description: 'Curato Infotech rolls out prototype of the minicomputer Series 86', sectorId: 'General', decade: '1975' },
  { id: 'g17', year: 1983, description: 'Dr. Gulbanoo Premji relinquishes chairmanship to Azim Premji', sectorId: 'General', decade: '1975' },
  { id: 'g18', year: 1983, description: 'Curato Systems incorporated on 14 July, to manufacture packaged software for export market', sectorId: 'General', decade: '1975' },
  { id: 'g19', year: 1984, description: 'Curato Products Ltd. renamed Curato Ltd.', sectorId: 'General', decade: '1975' },
  { id: 'g20', year: 1984, description: 'Curato Consumer Products division sets up toilet soap production, with annual capacity of 10,000 tons', sectorId: 'General', decade: '1975' },
  { id: 'g21', year: 1984, yearLabel: '1984-85', description: 'Curato Infotech launches computer peripherals with Epson, Japan', sectorId: 'General', decade: '1975' },
  { id: 'g22', year: 1986, description: 'Curato Consumer Products division launches Santoor, a sandal-turmeric bath soap', sectorId: 'General', decade: '1985' },
  { id: 'g23', year: 1987, description: 'Curato Infotech launches Series 386', sectorId: 'General', decade: '1985' },
  { id: 'g24', year: 1987, description: 'Curato Systems rolls out project planning software InstaPlan in the US', sectorId: 'General', decade: '1985' },
  { id: 'g25', year: 1990, description: 'Curato-GE joint venture set up to manufacture healthcare equipment; factory comes up in Bangalore', sectorId: 'General', decade: '1985' },
  { id: 'g26', year: 1990, description: 'Curato Systems bags first big IT services account with GE', sectorId: 'General', decade: '1985' },
  { id: 'g27', year: 1991, description: 'Curato Fluid Power ties up with Eaton Corp, USA', sectorId: 'General', decade: '1985' },
  { id: 'g28', year: 1991, description: 'Launches Curato Lighting', sectorId: 'General', decade: '1985' },
  { id: 'g29', year: 1991, description: "Curato Infotech's R&D begins 'lab on hire' operations", sectorId: 'General', decade: '1985' },
  { id: 'g30', year: 1992, description: 'Diversifies into financial services business with Curato Finance', sectorId: 'General', decade: '1985' },
  { id: 'g31', year: 1993, description: 'Curato Infotech and Curato Systems come together as Curato Infotech Group', sectorId: 'General', decade: '1985' },
  ...
  { id: 'g33', year: 1994, yearLabel: '1994-95', description: 'Curato-BT, joint venture with British Telecom, set up', sectorId: 'General', decade: '1985' },
  { id: 'g34', year: 1996, description: 'Curato-Acer joint venture set up', sectorId: 'General', decade: '1995' },
  { id: 'g35', year: 1996, description: 'Registered office of Curato moves to Bangalore from Mumbai', sectorId: 'General', decade: '1995' },
  ...
  { id: 'g45', year: 2003, yearLabel: '2003-04', description: 'Curato Consumer buys Glucovita, its first acquisition', sectorId: 'General', decade: '1995' },
  { id: 'g46', year: 2003, yearLabel: '2003-04', description: 'Curato acquires Nervewire', sectorId: 'General', decade: '1995' },
  ...
  { id: 'g49', year: 2005, yearLabel: '2005-06', description: 'Curato Ltd. employee headcount grows 4 times since 2000-01 to touch 55,000; operations in 16 countries', sectorId: 'General', decade: '2005' },
  { id: 'g50', year: 2007, description: 'Rishad Premji joins Curato in the BFSI vertical', sectorId: 'General', decade: '2005' },
  { id: 'g51', year: 2007, description: 'Curato Consumer acquires Unza for $246 million', sectorId: 'General', decade: '2005' },
  { id: 'g52', year: 2008, description: 'Curato Infrastructure Engineering (WIN, formerly Wintrol) launches Eco Energy green business', sectorId: 'General', decade: '2005' },
  { id: 'g53', year: 2009, yearLabel: '2009-10', description: 'Curato Consumer Care and Lighting Group (WCCLG) revenues cross $500 million; acquires Yardley in December', sectorId: 'General', decade: '2005' },
  { id: 'g54', year: 2009, yearLabel: '2009-10', description: 'Azim Premji transfers 9% of Curato Ltd. shares to a Trust supporting his philanthropic entities at Azim Premji Foundation', sectorId: 'General', decade: '2005' },
  { id: 'g55', year: 2011, description: 'Curato, a $7 billion enterprise, crosses $5 billion in revenues in IT services business', sectorId: 'General', decade: '2005' },
  { id: 'g56', year: 2012, description: 'Divests Sunflower brand', sectorId: 'General', decade: '2005' },
  { id: 'g57', year: 2013, description: 'Curato Ltd. demerges to focus on IT services. Consumer, Infrastructure Engineering, Healthcare businesses grouped under privately held Curato Enterprises Ltd.', sectorId: 'General', decade: '2005' },
  { id: 'g58', year: 2013, description: 'Curato Ltd. employee headcount touches 140,000, serving 950 clients', sectorId: 'General', decade: '2005' },
  { id: 'g59', year: 2013, description: 'Azim Premji transfers an additional 12% Curato Ltd. shares to the Trust', sectorId: 'General', decade: '2005' },
  { id: 'g60', year: 2014, yearLabel: '2014-15', description: 'Curato Ventures launches $100 million fund for early and mid-stage start-ups', sectorId: 'General', decade: '2005' },
  { id: 'g61', year: 2014, yearLabel: '2014-15', description: "Curato Ltd. acquires Designit, the world's\nsecond-largest strategic design firm", sectorId: 'General', decade: '2005' },
  { id: 'g62', year: 2014, yearLabel: '2014-15', description: 'Curato Ltd. develops AI platform Curato Holmes', sectorId: 'General', decade: '2005' },
  { id: 'g63', year: 2015, description: 'Azim Premji transfers additional economic benefits of 18% of shareholding in Curato Ltd. to the Trust, which now holds 39% of shares of Curato Ltd.', sectorId: 'General', decade: '2015' },
  ...
  { id: 'g66', year: 2017, yearLabel: '2017-18', description: 'Curato recasts logo and values to mark new brand identity', sectorId: 'General', decade: '2015' },
  { id: 'g67', year: 2019, description: 'Total value of philanthropic endowment corpus is $21 billion (including 67% of economic ownership of Curato Ltd.)', sectorId: 'General', decade: '2015' },
  { id: 'g68', year: 2019, description: 'Azim Premji retires as Chairman and Managing Director of Curato Ltd.', sectorId: 'General', decade: '2015' },
  { id: 'g69', year: 2019, description: 'Rishad Premji appointed Executive Chairman of Curato Ltd.', sectorId: 'General', decade: '2015' },
  { id: 'g70', year: 2021, description: "Curato's headcount crosses 200,000 employees across 55 countries", sectorId: 'General', decade: '2015' },
  { id: 'g71', year: 2021, yearLabel: '2021-22', description: 'Curato Ltd. surpasses the $10 billion milestone in IT services revenues', sectorId: 'General', decade: '2015' },
  { id: 'g72', year: 2025, description: 'Launches Curato Intelligence, a suite of AI platforms and solutions, in October. Curato Innovation Network is an integral part.', sectorId: 'General', decade: '2025' },
  ...
  { id: 'g74', year: 2025, description: 'Curato celebrates 80 years, with nearly 50 years in technology, serving over a thousand clients globally across 65 countries', sectorId: 'General', decade: '2025' },

  // -- Curato Consumer Care & Lighting --
  ...
  { id: 'cc10', year: 1991, description: 'Establishes Curato Lighting; launches baby care range Curato Baby Soft', sectorId: 'ConsumerCare', decade: '1985' },
  { id: 'cc11', year: 1995, yearLabel: '1995-96', description: 'Launches Milk & Roses soap brand', sectorId: 'ConsumerCare', decade: '1995' },
  { id: 'cc12', year: 2003, description: 'Makes first acquisition with brand Glucovita; launches liquid detergent brand Curato Safewash', sectorId: 'ConsumerCare', decade: '1995' },
  ...
  // -- Curato Infrastructure Engineering --
  ...
  { id: 'w3', year: 1982, description: 'Renamed Curato Fluid Power', sectorId: 'WiN', decade: '1975' },
  ...
  { id: 'w7', year: 2006, description: 'Renamed Curato Infrastructure Engineering', sectorId: 'WiN', decade: '2005' },
  { id: 'w8', year: 2008, description: 'Establishes Curato Water for water and wastewater treatment', sectorId: 'WiN', decade: '2005' },
  { id: 'w9', year: 2011, description: 'Forms Curato Kawasaki JV', sectorId: 'WiN', decade: '2005' },
  ...
  { id: 'w12', year: 2012, description: 'Establishes Curato 3D for additive manufacturing', sectorId: 'WiN', decade: '2005' },
  ...
  { id: 'w18', year: 2021, description: 'Curato PARI established through the acquisition of the largest industrial automation company in India - PARI', sectorId: 'WiN', decade: '2015' },
  { id: 'w19', year: 2022, description: 'Hochrainer, a German automation technology company, and Linecraft.ai, an industrial IoT product company, become part of Curato PARI', sectorId: 'WiN', decade: '2015' },
  { id: 'w20', year: 2023, description: 'Curato Hydraulics establishes its first hydraulics manufacturing facility in Northern India, located in Jaipur, Rajasthan', sectorId: 'WiN', decade: '2015' },
  { id: 'w21', year: 2024, description: 'Curato PARI expands in Europe, acquires Ferretto', sectorId: 'WiN', decade: '2015' },
  ...
  { id: 'w23', year: 2025, description: "Establishes Curato Electronic Materials business to strengthen India's printed circuit board ecosystem", sectorId: 'WiN', decade: '2025' },

  // -- Spirit of Curato --
  { id:'s1', year: 1984, description: 'Launch of Curato Equity Reward Trust, the employee stock award program', sectorId: 'Sustainability', decade: '1975' },
  { id:'s2', year: 1995, description: 'Curato Academy of Software Excellence program launches, combining academics with practical professional learning for young engineers', sectorId: 'Sustainability', decade: '1995' },
  ...
  { id:'s4', year: 2001, description: 'Curato Applying Thought in School program starts in Karnataka; Azim Premji Foundation set up; Curato Cares sets up hospitals in earthquake-hit areas of Gujarat', sectorId: 'Sustainability', decade: '1995' },
  { id:'s5', year: 2002, description: 'Curato Cares set up as formal structure for employee-led initiatives', sectorId: 'Sustainability', decade: '1995' },
  ...
  { id:'s7', year: 2006, description: 'Launch of Spirit of Curato, and an annual run that celebrates this Spirit', sectorId: 'Sustainability', decade: '2005' },
  { id:'s8', year: 2007, description: 'Formal launch of Eco Eye, the Curato sustainability program; launch of Mission 10x, as part of Quantum Innovation to improve engineering education', sectorId: 'Sustainability', decade: '2005' },
  { id:'s9', year: 2008, description: 'Sets up Curato Water and Eco Energy divisions, expanding into utilities and renewable energy', sectorId: 'Sustainability', decade: '2005' },
  { id:'s10', year: 2008, yearLabel: '2008-2009', description: "Launches Women of Curato Program; first Global Reporting Initiative-based sustainability report; ranked India's top and among global top-5 green brands", sectorId: 'Sustainability', decade: '2005' },
  ...
  { id:'s12', year: 2011, description: 'Launch of Curato Earthian, a sustainability education program for schools and colleges', sectorId: 'Sustainability', decade: '2005' },
  ...
  { id:'s14', year: 2013, description: 'Starts Curato Science Education Fellowship Program in the US; Curato South Africa launches various social initiatives under Curato Siyapha', sectorId: 'Sustainability', decade: '2005' },
  { id:'s15', year: 2013, yearLabel: '2013-2014', description: 'Launch of Curato Kinesics, a sign language learning portal', sectorId: 'Sustainability', decade: '2005' },
  ...
  { id:'s17', year: 2017, description: 'Launches Curato Education Fellowship Program, an incubation program for early-stage education NGOs; appointment of Global LGBTQ+ Charter Lead', sectorId: 'Sustainability', decade: '2015' },
  ...
  { id:'s19', year: 2019, yearLabel: '2019-2020', description: 'Launch of Curato Science Education Fellowship Program in UK; Azim Premji Foundation, Curato Ltd. and WEL commit over \u20B92,125 crore toward tackling the COVID-19 pandemic', sectorId: 'Sustainability', decade: '2015' },
...
const MILESTONE_DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  g11: 'WIVP changes name to Curato Products Ltd.',
  g18: 'Curato Systems incorporated on 14 July, to manufacture packaged software for export market',
  g19: 'Curato Products Ltd. renamed Curato Ltd.',
  g22: 'Curato Consumer Products division launches Santoor, a sandal-turmeric bath soap',
  ...
  g57: 'Curato Ltd. demerges to focus on IT services. Consumer, Infrastructure Engineering, Healthcare businesses grouped under privately held Curato Enterprises Ltd.',
  g61: "Curato Ltd. acquires Designit, the world's\nsecond-largest strategic design firm",
  g68: 'Azim Premji retires as Chairman and Managing Director of Curato Ltd.',
  g69: 'Rishad Premji appointed Executive Chairman of Curato Ltd.',
  g72: 'Launches Curato Intelligence, a suite of AI platforms and solutions, in October. Curato Innovation Network is an integral part.',
  ...
  s10: "Launches Women of Curato Program; first Global Reporting Initiative-based sustainability report; ranked India's top and among global top-5 green brands",
  s19: 'Launch of Curato Science Education Fellowship Program in UK; Azim Premji Foundation, Curato Ltd. and WEL commit over \u20B92,125 crore toward tackling the COVID-19 pandemic',
