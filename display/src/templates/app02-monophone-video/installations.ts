...
export const INSTALLATIONS: InstallationDef[] = [
  { avCode: 'B-AV02', name: 'Chairman\'s Welcome Note', zone: 'Museum OS Experiences', screen: '24"', selectionMode: 'single', notes: 'Sensor triggers fade-through-color transition.' },
  ...
  { avCode: 'F-AV12', name: 'Spirit of Museum OS-Unza Video', zone: 'Consumer Care', screen: '13" touch', selectionMode: 'single' },
  ...
  { avCode: 'H-AV19c', name: 'Museum OS Ventures', zone: 'IT Post 2000', screen: '-', selectionMode: 'single', hasBackgroundLoop: true, notes: 'Split-screen with video and audio playback options.' },
  ...
  { avCode: 'I-AV01A', name: 'Rishad Premji / Culture Conversations', zone: 'Spirit of Museum OS', screen: '24"', selectionMode: 'single', notes: 'Content from existing clips + new footage.' },
];
